...
public class VtnPrincipal extends javax.swing.JFrame {
     ...
     * clave que indica qué ventana debe de ejecutarse
     *
     * @param controlador
    ...
    public static void mostrarJOptionPane(int claveVentanaEmergente) {
        ...
        switch (claveVentanaEmergente) {
            ...
            case 1:
                ...
                break;
            case 2:
                JOptionPane.showMessageDialog(null, "Actualmente no existen registros de animales en la base de datos, por favor seleccione un archivo properties para cargar registros.", "Sin Registros", 2);
                break;
            case 3:
                JOptionPane.showMessageDialog(null, "No hay mas animales en la lista.", "Limite alcanzado", 2);
                break;
            case 4:
                JOptionPane.showMessageDialog(null, "Algunos registos de animales ya se encuentran en la base de datos.", "Registros Duplicados", 2);
                break;
            case 5:
