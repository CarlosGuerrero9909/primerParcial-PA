...
/**
 * Esta clase sabe manejar y entender las instrucciones SQL, es la que se comunica con la base de
 * datos a traves de la clase conexion, a la cual esta clase le envia peticiones y ordenes en sql
 *
...
public class AnimalDAO {
	...
	/**
	 * constructor donde declaramos nulos los atributos, ya que aun no se habran hecho instrucciones
	 * sql
	 */
	public AnimalDAO() {
		con = null;
	...
	/**
	 * Este metodo recibe objetos y estos mismos los inserta a la base de datos en forma de
	 * registros con instrucciones en sql
	 *
	 * @param mascota
	 */
	...
	/**
	 * Metodo encargado de modificar y actualisar los campos de algun registro en la DB, llegandole
	 * objetos y traduciendo esto a instrucciones sql
	 *
	 * @param codigo
	 * @return
	 */
	...
	/**
	 * Este metodo se encarga de eliminar registros completos de la base de datos segun el nombre
	 * que le llegue, esto lo traduce a instruccion sql y envia la instruccion a la conexion
	 *
	 * @param codigo
	 * @return
	 */
	...
	/**
	 * Metodo encargado de crear y retornar un arraylist de animales con todos los registros
	 * alojados en la base de datos, creando una conexion y recoperando todos los registros
	 *
	 * @return
	 */
