...
/**
 * Sabe manejar y entender las instrucciones SQL, es la que se comunica con la base de datos a
 * traves de la clase conexion enviandole sql
 *
...
public class AnimalDAO {
	...
	/**
	 * constructor donde declaramos nulos los atributos, ya que aun no se hbran hecho instrucciones
	 * sql
	 */
	public AnimalDAO() {
		con = null;
